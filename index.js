...
const chalk = require('chalk'); //colors/formats the terminal output
const compression = require('compression'); //gzip compressor
const errorHandler = require('errorhandler'); //ErrorHandler for Dev
